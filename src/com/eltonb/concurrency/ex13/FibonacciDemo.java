...
public class FibonacciDemo {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        TimeData synchRes1 = startFibonacci(45);
        TimeData synchRes2 = startFibonacci(46);
        TimeData synchRes3 = startFibonacci(47);
        ...
        CompletableFuture<TimeData> futureRes1 = CompletableFuture.supplyAsync(() -> startFibonacci(45));
        CompletableFuture<TimeData> futureRes2 = CompletableFuture.supplyAsync(() -> startFibonacci(46));
        CompletableFuture<TimeData> futureRes3 = CompletableFuture.supplyAsync(() -> startFibonacci(47));

        if (true)
            return;

        // wait for results from the asynchronous operations
        TimeData asynchRes3 = futureRes3.get();
        TimeData asynchRes2 = futureRes2.get();
        TimeData asynchRes1 = futureRes1.get();
